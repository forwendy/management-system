<template>
  <div class="form-artcile">
    <UEditor ref="editor" class="ueditor-content" name="formArtcile" :config="editorOpt" @input="ueditorInput" @ready="ready"></UEditor>
    ...
    <el-dialog v-if="dialogImage" title="插入图片" :visible.sync="dialogImage" append-to-body width="700px">
      <upload type="image" @submit="insertImage"></upload>
    </el-dialog>
    <el-dialog v-if="dialogVideo" title="插入视频" :visible.sync="dialogVideo" append-to-body width="700px">
      <upload type="video" @submit="insertVideo"></upload>
    </el-dialog>
  </div>
</template>
