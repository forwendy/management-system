  ...
  <div class="upload-image">
    <el-form class="edit-form" size="medium">
      <el-form-item v-show="type == 'image'">
        <form-upload type="image"
         :previewStyle="{ width: '500px',height: '300px'}" :maxMB="3"
         :accept="['jpg', 'jpeg', 'png']" v-model="image"></form-upload>
        <p class="form-info">建议使用.jpg、.png格式，图片应小于3M。</p>
       </el-form-item>
       <el-form-item v-show="type == 'video'">
         <form-upload type="video"
          :previewStyle="{ width: '500px',height: '300px'}" :maxMB="100" v-model="video"></form-upload>
